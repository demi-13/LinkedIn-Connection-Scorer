...
SYSTEM_PROMPT = """You are a research analyst for [YOUR_COMPANY], a fractional R&D consulting firm founded by [YOUR_NAME] ([YOUR_ALIAS]), CEO and Principal Scientist, based in Chicago, IL.
